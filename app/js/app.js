...
four51.app = angular.module('451order', ['ngResource', 'ngRoute', 'ngAnimate', 'ngSanitize', 'ngCookies', 'ngTouch', 'ui.validate', 'ui.mask', 'headroom', 'ui.bootstrap',
    'angulartics', 'angulartics.google.analytics', 'ngAutocomplete', 'OrderCloud-AnonRouter','OrderCloud-SpecForms', 'OrderCloud-Mandrill', 'OrderCloud-BackToTop', 'OrderCloud-Breadcrumbs',
    ...
    'OrderCloud-SecurityModal', 'OrderCloud-TermsModal', 'OrderCloud-CategoryCollapse', 'OrderCloud-UtilityNavigation', 'OrderCloud-LargeAddressListSearch', 'OrderCloud-CostCenterSearch',
    'OrderCloud-CustomKitForm']);
